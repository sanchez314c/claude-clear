...
echo -e "${PURPLE}"
cat "$SCRIPT_DIR/resources/banner.txt"
echo -e "${NC}"
...
BG_PID=$!
show_spinner $BG_PID "Copying files"
wait $BG_PID || { echo -e "${RED}Error: File copy failed${NC}"; exit 1; }
...
echo -e "${GRAY}Report issues at: https://github.com/sanchez314c/claude-clear/issues${NC}"