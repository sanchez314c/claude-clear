...
# Or from GitHub
pip install -e git+https://github.com/sanchez314c/claude-clear.git
```
...
curl -fsSL https://raw.githubusercontent.com/sanchez314c/claude-clear/main/scripts/install.sh | bash

# Or download first
wget https://raw.githubusercontent.com/sanchez314c/claude-clear/main/scripts/install.sh
chmod +x install.sh
./install.sh
```
...
# Or tap
brew tap sanchez314c/claude-clear
brew install claude-clear
```
...
- [GitHub Issues](https://github.com/sanchez314c/claude-clear/issues) for support